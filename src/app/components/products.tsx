  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center drop-shadow-[0_-5px_25px_rgba(0,0,0,0.25)]">
        <div className="absolute w-[4.5rem] h-[4.5rem] sm:w-28 sm:h-28 md:w-44 md:h-44 rounded-full bg-secondary transform -translate-x-10 -translate-y-20 sm:-translate-x-20 sm:-translate-y-40 md:-translate-x-32 md:-translate-y-60"></div>
        <div className="absolute w-[4.5rem] h-[4.5rem] sm:w-28 sm:h-28 md:w-44 md:h-44 rounded-full bg-secondary transform translate-x-10 -translate-y-20 sm:translate-x-20 sm:-translate-y-40 md:translate-x-32 md:-translate-y-60"></div>
        <div className="absolute w-20 h-20 sm:w-32 sm:h-32 md:w-48 md:h-48 rounded-full bg-primary transform -translate-y-24 sm:-translate-y-48 md:-translate-y-[17rem]"></div>
      </div>
